          ...
          {isOpen && (
            <>
              ...
              <div className="relative z-50">
                {/* Portal container helper if needed, but we are portaling the whole thing */}
              </div>
              ...
              >
                ...
                {view === "list" && (
                  ...
                  >
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2 border-t border-dashed border-border pt-4 md:mt-3 md:pt-3">
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                ...
                {view === "create" && (
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                  >
                    <div className="mb-4 flex items-center gap-2 md:mb-2">
                      <Button
                        type="button"
                        variant="ghost"
                        size="sm"
                    ...
                    <form className="space-y-3 md:space-y-2" onSubmit={handleCreate}>
      ...
      <div className="relative">
        {trigger ? (
          ...
          <Button
            type="button"
            variant="ghost"
            className="flex h-11 items-center gap-2 rounded-full border border-border bg-muted/70 pl-1.5 pr-3 py-1.5 text-xs font-medium"
